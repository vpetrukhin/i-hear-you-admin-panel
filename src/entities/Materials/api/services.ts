...
export const deleteFile = async (id: number): Promise<MaterialType[]> => {
  const link = MATERIALS_API_URL_MAP.file(String(id));
  const res = await request.delete<any>(link);
  return res.data;
};

export const fileRequest = async (id: number) => {
  const res = await request.get<MaterialType>(
    MATERIALS_API_URL_MAP.file(String(id)),
  );
  return res.data;
};
...
export const updateFile = async (
  ...
  const res = await request.patch<
    ...
    AxiosResponse<MaterialType>,
    FormData
  >(MATERIALS_API_URL_MAP.file(String(id)), dto);
...
export const createCategory = async (createCategoryDTO: CreateCategoryDTO) => {
  const res = await request.post<
    MaterialCategoryType,
    AxiosResponse<MaterialCategoryType>,
    CreateCategoryDTO
  >(CATEGORIES_API_URL_MAP.create, createCategoryDTO);
...
export const updateCategory = async (
  ...
  const res = await request.patch<
    ...
    AxiosResponse<MaterialCategoryType>,
    CreateCategoryDTO
  >(CATEGORIES_API_URL_MAP.update(categoryId), categoryDTO);
...
export const createTopic = async (createTopicDTO: CreateTopicDTO) => {
  const res = await request.post<
    MaterialCategoryType,
    AxiosResponse<MaterialTopicType>,
    CreateTopicDTO
  >(TOPICS_API_URL_MAP.create, createTopicDTO);
...
export const updateTopic = async (
  topicId: string,
  topicDTO: CreateCategoryDTO,
) => {
  const res = await request.patch<
    MaterialTopicType,
    AxiosResponse<MaterialTopicType>,
    CreateCategoryDTO
  >(TOPICS_API_URL_MAP.update(topicId), topicDTO);
